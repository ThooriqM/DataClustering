...
% melakukan k means dengan cluster = 5
cluster = 5;
...
hold on
plot(X(idx==3,1),X(idx==3,2),'k*','MarkerSize',5)
hold on
plot(X(idx==4,1),X(idx==4,2),'m*','MarkerSize',5)
hold on
plot(X(idx==5,1),X(idx==5,2),'g*','MarkerSize',5)

plot(C(:,1), C(:,2),'kx', 'MarkerSize',15,'LineWidth',3) 
legend('Cluster 1','Cluster 2','Cluster 3',...
       'Cluster 4','Cluster 5','Centroids','Location','NW')
